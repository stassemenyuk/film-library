...
export default class FilmModal extends Component {
  render() {
    const { title, src, genre, alt, descr, onClose, onLike, onImportant } = this.props;
    return (
      <div className="modal__window">
        ...
        <div className="modal__content">
          <div className="modal__film-title">{title}</div>
          <div className="modal__film-genre">{genre}</div>
          <div className="modal__film-info">
            <div className="modal__film-img">
              <img src={src} alt={alt} />
            </div>
            <div className="modal__film-plot">{descr}</div>
          </div>
